...
For our scenario, using probability estimations is better than hard classification. Foragers can make their own judgments on what probability of toxicity they are comfortable with, as foragers prone to more risky behavior could have a lower FN cost and therefore be more willing to take their chances. There are plenty of mushrooms that are deemed toxic but will ultimately only cause a stomachache, so situations are not necessarily life or death and foragers' risk tolerance can reflect this as well.
